...
namespace Algorithms.Application
{
    public class Meeting
    {
        ...
        public static List<Meeting> CalenderMeeting(List<Meeting> myCalender, Meeting myDailyBounds, List<Meeting> coworkerCalender, Meeting coworkerDailyBounds, int meetingDuration)
        {
    ...
    public static class ArrayMethods
    {
        ...
        public static int[] TwoNumberSumUsingTraversal(int[] array, int targetSum)
        {
        ...
        //Time Complexity: O(n)
        //Space Complexity: O(1)
        public static int[] MoveElementToStart(int[] array, int toMove)
        {
        ...
        //Time Complexity: O(n^2)
        //Space Complexity: O(1)
        public static int[] FindSmallestUnSortedSubArrayIndices_MethodOne(int[] array)
        {
        ...
        //Time Complexity: O(n)
        //Space Complexity: O(1)
        public static int[] FindSmallestUnSortedSubArrayIndices_MethodTwo(int[] array)
        {
            int highest = Int32.MinValue, lowest = Int32.MaxValue;
        ...
        //Time Complexity: O(n)
        //Space Complexity: O(n)
        public static int[] FindLargestRange(int[] array)
        {
        ...
        //Time Complexity: O(n^2)
        //Space Complexity: O(n)
        public static int FindMinimumRewards_MethodOne(int[] scores)
        {
        ...
        //Time Complexity: O(n)
        //Space Complexity: O(n)
        public static int FindMinimumRewards_MethodTwo(int[] scores)
        {
            int[] rewards = new int[scores.Length];
            Array.Fill(rewards, 1);
        ...
        //Space Complexity: O(1)
        public static int FindApartment_MethodOne(List<Dictionary<string,bool>> blocks, string[] reqs)
        {
        ...
        public static int FindApartment_MethodTwo(List<Dictionary<string,bool>> blocks, string[] reqs)
        {
