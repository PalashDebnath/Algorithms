...
namespace Algorithms.Application
{
    ...
    public class Find
    {
        ...
        //Space Complexity: O(1)
        public static int Apartment_MethodOne(List<Dictionary<string,bool>> blocks, string[] reqs)
        {
        ...
        public static int Apartment_MethodTwo(List<Dictionary<string,bool>> blocks, string[] reqs)
        {
